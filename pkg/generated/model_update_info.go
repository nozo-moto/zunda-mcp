...
func (o *UpdateInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateInfo := _UpdateInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateInfo)

	if err != nil {
		return err
	}

	*o = UpdateInfo(varUpdateInfo)
