...
func (o *ParseKanaBadRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varParseKanaBadRequest := _ParseKanaBadRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varParseKanaBadRequest)

	if err != nil {
		return err
	}

	*o = ParseKanaBadRequest(varParseKanaBadRequest)
