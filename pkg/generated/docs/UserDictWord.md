...
**Surface** | **string** | 表層形 | 
**Priority** | **int32** | 優先度 | 
**ContextId** | Pointer to **int32** | 文脈ID | [optional] [default to 1348]
...
**InflectionalType** | **string** | 活用型 | 
**InflectionalForm** | **string** | 活用形 | 
**Stem** | **string** | 原形 | 
**Yomi** | **string** | 読み | 
**Pronunciation** | **string** | 発音 | 
**AccentType** | **int32** | アクセント型 | 
**MoraCount** | Pointer to **int32** | モーラ数 | [optional] 
**AccentAssociativeRule** | **string** | アクセント結合規則 | 
