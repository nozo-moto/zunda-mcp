...
------------ | ------------- | ------------- | -------------
**Id** | **int32** | スタイルID | 
**Icon** | **string** | このスタイルのアイコンをbase64エンコードしたもの、あるいはURL | 
**Portrait** | Pointer to **string** | このスタイルの立ち絵画像をbase64エンコードしたもの、あるいはURL | [optional] 
**VoiceSamples** | **[]string** | サンプル音声をbase64エンコードしたもの、あるいはURL | 
