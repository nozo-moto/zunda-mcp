...
------------ | ------------- | ------------- | -------------
**Moras** | [**[]Mora**](Mora.md) | モーラのリスト | 
**Accent** | **int32** | アクセント箇所 | 
**PauseMora** | Pointer to [**Mora**](Mora.md) | 後ろに無音を付けるかどうか | [optional] 
**IsInterrogative** | Pointer to **bool** | 疑問系かどうか | [optional] [default to false]
