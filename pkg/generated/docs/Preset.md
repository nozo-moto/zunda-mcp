...
**Id** | **int32** | プリセットID | 
**Name** | **string** | プリセット名 | 
**SpeakerUuid** | **string** | キャラクターのUUID | 
**StyleId** | **int32** | スタイルID | 
...
**PauseLength** | Pointer to **float32** | 句読点などの無音時間 | [optional] 
**PauseLengthScale** | Pointer to **float32** | 句読点などの無音時間（倍率） | [optional] [default to 1]
