...
type _AccentPhrase AccentPhrase
...
func (o *AccentPhrase) UnmarshalJSON(data []byte) (err error) {
	...
	varAccentPhrase := _AccentPhrase{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAccentPhrase)

	if err != nil {
		return err
	}

	*o = AccentPhrase(varAccentPhrase)
